...
object VinmonopoletApiMapper {
  ...
  fun map2ProductLine(product: Product): Productline {
    ...
    return Productline(
        ...
        butikkategori = "NONE",
        fylde = 0, //product.description.fullness,
        friskhet = 0, //product.description.freshness,
        garvestoffer = 0, //product.description.tannins,
        bitterhet = 0, //product.description.bitterness,
        sodme = 0, //product.description.sweetness,
        ...
        sukker = product.ingredients.sugar,
        syre = StringUtils.trimToNull(product.ingredients.acid),
        lagringsgrad = StringUtils.trimToNull(product.properties.storagePotential),
        ...
        emballasjetype = product.basic.packagingMaterial,
        korktype = StringUtils.trimToNull(product.basic.corkType),
